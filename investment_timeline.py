...
print('Percentage emission reduced from 2016 total carbon footprint: %s %%' %(Cum_carbon_savings[-1]/init_emissions*100))
print('Percentage emission reduced from BAU: %s %%' %(Cum_carbon_savings[-1]/BAU_emissions*100))